...
from models.resnet_cac import ResNet18 as ResNet18_CAC
from attack import FGSM_REG, FGSM_REG_cac
...
parser.add_argument('--learning_rate', '-lr', type=float, default=0.1, help='learning rate default: 1e-1')
parser.add_argument('--weight_decay', '-w', type=float, default=5e-4,
                    help='the parameter of l2 restriction for weights default: 1e-4')
        ...
        for epoch in range(1, args.max_epoch + 1):
            ...
            for data, label in tr_loader:
                ...
                if adv_train:
                    ...
                    # kl_loss = F.kl_div(F.log_softmax(output_1, dim=1), F.softmax(output_2, dim=1), reduction='batchmean')
...
def main(args):
    ...
    model = ResNet18_CAC(num_classes=10)
